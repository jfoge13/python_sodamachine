...
class Customer:
    ...
    def gather_coins_from_wallet(self, selected_soda):
        ...
        while will_proceed:
            user_interface.User_interface.display_can_cost(selected_soda)
            user_interface.User_interface.display_payment_value(
                customer_payment)
            coin_name = user_interface.User_interface.coin_selection()
            if coin_name == "done":
                break
    ...
    def check_coins_in_wallet(self):
        ...
        user_interface.User_interface.display_customer_wallet_info(
